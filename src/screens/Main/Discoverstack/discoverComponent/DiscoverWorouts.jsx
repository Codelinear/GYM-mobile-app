...
const DiscoverWorouts = ({navigation}) => {
    ...
    <>
      <ScrollView style={tailwind`flex-1`}>
        <View
          ...
          {/* <CalendarView fetchWorkouts={fetchData} /> */}
          {data?.reverse().map((item, index) => (
            <View key={index} style={tailwind`hfull relative`}>
              <View
                key={index}
                style={tailwind`bg-[#F2F8FF] rounded-[8px] p-4 w-[350px]`}>
              ...
              <View style={tailwind`py-5`}>
                {item.workouts.map((work, indexx) => (
                  <View
                    key={indexx}
                    style={tailwind`border-b border-[#00000050]`}>
                    <View style={tailwind` flex-row justify-between my-1`}>
                      <View style={tailwind` flexrow justify-between my-1`}>
...
export default DiscoverWorouts;
